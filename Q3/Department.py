...
class Department:
    ...
    def searchEmployee(self, employeeId:int):
        '''searchEmployee method searches the employee list using given employeeId given as parameter. returns the employee object with the matching matching employeeId. return None otherwise.'''
